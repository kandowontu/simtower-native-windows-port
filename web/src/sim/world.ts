...
export interface EventState {
	...
	/** Client viewport in world-cell coordinates for the original six-bucket news sampler. */
	newsViewport?: { left: number; top: number; width: number; height: number };
	/**
...
export type SimNotification = {
	kind: "route_failure" | "event" | "star_advanced" | "sound";
	message?: string;
	/** Original WAVE resource ID. Sound-only notices intentionally have no message. */
